...
Config.qtarget.MaxDistance = 7.0

-- Enable debug options
Config.qtarget.Debug = false

-- Enable default options (Toggling vehicle doors)
Config.qtarget.EnableDefaultOptions = true

-- Whether to have the target as a toggle or not
Config.qtarget.Toggle = false

-- Draw a Sprite on the center of a PolyZone to hint where it's located
Config.qtarget.DrawSprite = false

-- The default distance to draw the Sprite
Config.qtarget.DrawDistance = 10.0
...
Config.qtarget.DrawColor = {255, 255, 255, 255}
...
Config.qtarget.SuccessDrawColor = {98, 135, 236, 255}

-- Enable outlines around the entity you're looking at
Config.qtarget.EnableOutline = false
...
Config.qtarget.OutlineColor = {255, 255, 255, 255}
...
Config.qtarget.MenuControlKey = 237

-- Key to open the target eye, here you can find all the names: https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
Config.qtarget.OpenKey = 'LMENU' -- Left Alt

-- Supported values: 'ESX', 'QB', false
Config.qtarget.Framework = false
...
CreateThread(function()
	if not Config.qtarget.Framework then
		...
		if state ~= 'missing' then
			...
			Config.qtarget.Framework = framework == 'es_extended' and 'ESX' or 'QB'
		end
	end

	if Config.qtarget.Framework == 'ESX' then
	...
	elseif Config.qtarget.Framework == 'QB' then
